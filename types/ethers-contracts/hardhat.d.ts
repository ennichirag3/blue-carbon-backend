...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'CarbonToken', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.CarbonToken__factory>
getContractFactory(name: 'Counter', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.Counter__factory>

  getContractAt(name: 'CarbonToken', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.CarbonToken>
getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>

  deployContract(name: 'CarbonToken', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CarbonToken>
deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>

  deployContract(name: 'CarbonToken', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CarbonToken>
